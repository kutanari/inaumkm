            ...
            <div class="container px-5 py-12 mx-auto">
                <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center animate-fade-up animate-once animate-ease-in-out">
                    ...
                    <p x-show="shown" class="animate-fade-up animate-once animate-ease-in-out leading-relaxed text-lg animate-delay-200">Kami memulai Inaproduct dari sebuah keresahan. Pada 2021, jumlah
                        ...
                        Kontribusi UMKM terhadap pasar ekspor masih jauh tertinggal dibanding negara ASEAN lain. UMKM
                        membutuhkan bantuan pengembangan agar lebih berdaya saing. Karena itulah Inaproduct hadir pada
                        2021. Inaproduct adalah perusahaan jasa pengembang bisnis untuk UMKM di Indonesia.</p>
        ...
        <div class="text-gray-600 bg-slate-100" x-data="{shown: false}" x-intersect.half="shown = true">
            <div class="container mx-auto flex px-5 py-12 md:flex-row flex-col items-center">
                ...
                <div class="lg:max-w-xs lg:w-full md:w-1/2 w-5/6">
                    <img class="object-cover object-center rounded-lg" alt="hero" src="/images/ceo.jpg">
                </div>
            </div>
        </div>
                ...
                <div class="flex flex-wrap justify-center -m-4 text-center" x-data="{shown: false}" x-intersect.half="shown = true">
                    <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div x-show="shown" class="px-4 py-6 rounded-lg shadow-xl border border-1 border-slate-200 animate-fade-up animate-once animate-ease-in-out">
                            ...
                            <h2 class="title-font font-medium text-3xl text-gray-900">Directori UMKM Online</h2>
                            <p class="leading-relaxed">Anda dapat bergabung dengan direktori bisnis Inaproduct untuk memperluas jangkauan di pasar B2B.</p>
                        </div>
                    </div>
                    <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div x-show="shown" class="px-4 py-6 rounded-lg shadow-xl border border-1 border-slate-200 animate-fade-up animate-once animate-ease-in-out animate-delay-300">
                            ...
                            <h2 class="title-font font-medium text-3xl text-gray-900">Program Akselerasi UMKM</h2>
                            <p class="leading-relaxed">Anda bisa menikmati program-program kami untuk mengembangkan bisnis dan meningkatkan daya saing.</p>
                        </div>
                    </div>
                </div>
