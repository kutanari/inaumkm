<x-front.hero-section>
    {{-- <x-authentication-card>
        ...
        <h1 class="w-full text-lg font-bold text-center">Masuk</h1>
        ...
        <form method="POST" action="{{ route('login') }}" class="w-full">
            ...
            <div class="mt-4">
                ...
                <x-input id="password" placeholder="********" class="placeholder-gray-300 block mt-1 w-full" type="password" name="password" required autocomplete="current-password" />
            </div>
            ...
            <div class="items-center justify-end mt-4">
                <x-primary-button class="w-full lg:block">{{ __('Masuk') }}</x-primary-button>
