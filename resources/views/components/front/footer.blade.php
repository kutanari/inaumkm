<footer class="bg-primary-ina-red pt-10 pb-5">
    <div class="container">
        <div class="text-center grid grid-cols-1 justify-items-center gap-6 lg:grid-cols-12 lg:gap-0">
            <div class="flex flex-col justify-between lg:justify-self-start lg:col-span-3">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <a href="https://twitter.com/inaproductcom">
                        <svg class="text-white hover:text-primary-ina-orange fill-current cursor-pointer"
                    ...
                    <a href="https://id.pinterest.com/inaproductcom/">
                        <svg class="text-white hover:text-primary-ina-orange fill-current cursor-pointer"
                            xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                    ...
                    <a href="https://www.instagram.com/inaproductcom/">
                        <svg class="text-white hover:text-primary-ina-orange fill-current cursor-pointer"
                            xmlns="http://www.w3.org/2000/svg" width="21" height="20">
                    ...
                    <a href="https://www.tiktok.com/@inaproduct.com">
                        <svg class="text-white hover:text-primary-ina-orange" stroke="currentColor" fill="currentColor"  viewBox="0 0 448 512" height="20" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,121.43,0,0,0,67,20.14Z"></path></svg>
                    </a>
                </div>
            </div>
            ...
            <div
                ...
                <a class="hover:text-green-400" href="#">
                    Tentang Kami
                </a>
                <a class="hover:text-green-400" href="#">
                    Kontak
    ...
    <div class="container pt-10 text-white">
        Copyright © 2023 PT. Ina Produk Indonesia (inaproduct.com). All Rights Reserved
    </div>
</footer>
