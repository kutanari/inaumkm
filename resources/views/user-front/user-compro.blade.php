                ...
                <div class="relative">
                    <div class="absolute right-0 flex-1 flex flex-col items-center lg:items-end justify-end px-8 mt-2 print:hidden">
                        <div class="flex items-center space-x-4 mt-2">
                            ...
                            <a href="{{ route('download-compro', 'pdf') }}" class="flex items-center bg-blue-600 hover:bg-blue-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
