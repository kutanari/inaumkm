        ...
        <div class="relative overflow-hidden">
            ...
            <div class="text-xl relative bg-gradient-to-r from-orange-400 to-transparent w-full h-full top-0 md:p-16 p-6 flex flex-col justify-between">
                <div>
                    ...
                    <p class="text-lg leading-6 text-white xl:w-5/12 lg:w-8/12 md:w-10/12  2xl:pr-12 mt-4">Sebuah Kolaborasi untuk Menaikkan Kelas UMKM.</p>
                </div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <x-user-welcome :persenCompletness="$persen_completness" />
            </div>
        </div>
    </div>
</x-app-layout>
